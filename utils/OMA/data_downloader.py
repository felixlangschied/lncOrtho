...
# takes a list of absolute paths to fasta files and
# renames the files to a format supported by OMA standalone
# if the path in 'output' is different than the input directory,
# process_input will create copies of the files instead of renaming them
